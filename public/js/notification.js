class BladewindNotification {
    ...
    template = () => {
        return `<div class="flex border-l-4 border-opacity-50 ${this.name} border-${this.type}-500 bg-white dark:bg-slate-700 dark:border-0 dark:shadow-xl dark:shadow-slack-900 shadow-xl  p-4 rounded-lg mb-3">
