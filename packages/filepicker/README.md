[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/mkocansey/bladewind-filepicker)](https://packagist.org/packages/mkocansey/bladewind-filepicker)
...
```bash
composer require mkocansey/bladewind-filepicker
```
