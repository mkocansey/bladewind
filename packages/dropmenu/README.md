[![License](https://img.shields.io/github/license/mkocansey/bladewind)](https://github.com/mkocansey/bladewind/blob/main/LICENSE) [![Packagist Version](https://img.shields.io/packagist/v/mkocansey/bladewind-dropmenu)](https://packagist.org/packages/mkocansey/bladewind-dropmenu)
...
```bash
composer require mkocansey/bladewind-dropmenu
```
