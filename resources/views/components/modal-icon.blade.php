...
<x-bladewind::icon name="exclamation-circle" type="solid"
                   class="warning text-amber-400 dark:!text-amber-500 {{$class}} {{$warning_css}}"/>
<x-bladewind::icon name="information-circle" type="solid"
