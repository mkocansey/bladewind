...
<div class="relative px-2 py-3 border-2 border-dashed border-gray-300 dark:text-dark-300 dark:border-dark-700
    ...
    <x-bladewind::icon name="document-text" class="h-6 w-6 absolute z-20 ltr:left-4 rtl:right-4 text-gray-300"/>
    <x-bladewind::icon name="paperclip" class="h-4 w-4 absolute z-10 rtl:left-4 opacity-50"
                       dir="vendor/bladewind/icons/outline"/>
    <x-bladewind::icon name="x-circle"
                       class="absolute ltr:right-3 rtl:left-3 h-8 w-8 text-gray-600 hover:text-gray-800 clear cursor-pointer hidden"
                       type="solid"/>
