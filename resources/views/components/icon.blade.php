...
@php 
    $dir = (! in_array($type, [ 'outline', 'solid' ])) ? 'outline' : $type; 
    $svg_file = file_exists(realpath("vendor/bladewind/icons/$dir/$name.svg")) ? 
        realpath("vendor/bladewind/icons/$dir/$name.svg") : null;
@endphp
@if (!empty($name))
