...
<div class="bw-statistic bg-white dark:bg-slate-800 dark:border dark:border-slate-700/50 p-6 rounded-md relative @if($has_shadow)shadow-2xl shadow-gray-200/40 dark:shadow-xl dark:shadow-slate-900 @endif {{$class}}">
