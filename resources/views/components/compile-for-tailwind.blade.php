@props([
    ...
    'colours'       => [
        ...
        'secondary'   => [
            ...
            'text'      => 'text-secondary-50 text-secondary-500 hover:text-red-50 hover:text-secondary-700',
        ...
        'pink'    => [
            ...
            'text'      => 'text-pink-50 text-pink-100 text-pink-500 text-pink-700 hover:text-pink-50 hover:text-pink-700',
        ...
        'gray'    => [
            'bg'        => 'bg-slate-200/70 bg-transparent bg-gray-200 bg-gray-200/70 bg-gray-300 peer-checked:bg-gray-500/80 !bg-gray-500 bg-slate-500 hover:!bg-gray-500 hover:!bg-gray-700 active:bg-gray-700 !bg-black focus:ring-black hover:!bg-black active:!bg-black',
