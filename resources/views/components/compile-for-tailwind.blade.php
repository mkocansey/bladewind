@props([
    ...
    'colours'       => [
        'primary'   => [
            'bg'        => 'bg-primary-200 bg-primary-300 peer-checked:bg-primary-500/80 !bg-primary-500 hover:!bg-primary-500 hover:bg-primary-500 hover:!bg-primary-700 active:bg-primary-700 bg-dark-800 bg-dark-700',
        ...
        'secondary'   => [
            'bg'        => 'bg-secondary-200 bg-secondary-300 peer-checked:bg-secondary-500/80 !bg-secondary-400 bg-secondary-500 hover:!bg-secondary-500 hover:bg-secondary-500 hover:!bg-secondary-700 active:bg-secondary-700',
        ...
        'red'       => [
            'bg'        => 'bg-error-100/80 bg-red-200 bg-red-300 peer-checked:bg-red-500/80 !bg-red-500 dark:bg-error-600 hover:!bg-red-500 hover:bg-red-500 hover:!bg-red-700 active:bg-red-700 bg-error-500',
        ...
        'yellow'    => [
            'bg'        => 'bg-warning-100/80 bg-yellow-200 bg-yellow-200/70 bg-yellow-300 peer-checked:bg-yellow-500/80 !bg-yellow-500 dark:bg-warning-600 hover:!bg-yellow-500 hover:bg-yellow-500 hover:!bg-yellow-700 active:bg-yellow-70 bg-warning-5000',
        ...
        'green'    => [
            'bg'        => 'bg-success-100/80 bg-green-200 bg-green-300 peer-checked:bg-green-500/80 !bg-green-500 dark:bg-success-600 hover:!bg-green-500 hover:bg-green-500 hover:!bg-green-700 active:bg-green-700 bg-success-500',
        ...
        'blue'    => [
            'bg'        => 'bg-info-100/80 bg-blue-200 bg-blue-300 peer-checked:bg-blue-500/80 !bg-blue-500 hover:!bg-blue-500 hover:bg-blue-500 dark:bg-info-600 dark:text-[type]-100 hover:!bg-blue-700 active:bg-blue-700 bg-info-500',
        ...
        'orange'    => [
            'bg'        => 'bg-orange-200/70 bg-orange-200 bg-orange-300 peer-checked:bg-orange-500/80 !bg-orange-500 hover:!bg-orange-500 hover:bg-orange-500 hover:!bg-orange-700 active:bg-orange-700',
        ...
        'purple'    => [
            'bg'        => 'bg-purple-200/70 bg-purple-200 bg-purple-300 peer-checked:bg-purple-500/80 !bg-purple-500 hover:!bg-purple-500 hover:bg-purple-500 hover:!bg-purple-700 active:bg-purple-700',
        ...
        'cyan'    => [
            'bg'        => 'bg-cyan-200/70 bg-cyan-200 bg-cyan-300 peer-checked:bg-cyan-500/80 !bg-cyan-500 hover:!bg-cyan-500 hover:bg-cyan-500 hover:!bg-cyan-700 active:bg-cyan-700',
        ...
        'pink'    => [
            'bg'        => 'bg-pink-200/70 bg-pink-200 bg-pink-300 peer-checked:bg-pink-500/80 !bg-pink-500 hover:!bg-pink-500 hover:bg-pink-500 hover:!bg-pink-700 active:bg-pink-700',
        ...
        'violet'    => [
            'bg'        => 'bg-violet-200/70 bg-violet-200 bg-violet-300 peer-checked:bg-violet-500/80 !bg-violet-500 hover:!bg-violet-500 hover:bg-violet-500 hover:!bg-violet-700 active:bg-violet-700',
        ...
        'indigo'    => [
            'bg'        => 'bg-indigo-200/70 bg-indigo-200 bg-indigo-300 peer-checked:bg-indigo-500/80 !bg-indigo-500 hover:!bg-indigo-500 hover:bg-indigo-500 hover:!bg-indigo-700 active:bg-indigo-700',
        ...
        'fuchsia'    => [
            'bg'        => 'bg-fuchsia-200/70 bg-fuchsia-200 bg-fuchsia-300 peer-checked:bg-fuchsia-500/80 !bg-fuchsia-500 hover:!bg-fuchsia-500 hover:bg-fuchsia-500 hover:!bg-fuchsia-700 active:bg-fuchsia-700',
        ...
        'gray'    => [
            'bg'        => 'bg-slate-200/70 bg-transparent bg-gray-200 bg-gray-200/70 bg-gray-300 peer-checked:bg-gray-500/80 !bg-gray-500 bg-slate-500 hover:!bg-gray-500 hover:bg-gray-500 hover:!bg-gray-700 active:bg-gray-700 !bg-black focus:ring-black hover:!bg-black active:!bg-black',
